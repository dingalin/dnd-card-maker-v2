...
export class LassoTool {
    constructor() {
        ...
        this.tolerance = 10;
        this.templateImage = null;  // The empty template to analyze
        this.displayCanvas = null;  // The full canvas to show for reference
        this.onConfirm = null;
     ...
     */
    open(templateImage, displayCanvas, onConfirm) {
    ...
    createModal() {
        ...
        this.previewCanvas = document.getElementById('lasso-preview-canvas');
        this.previewCanvas.width = 750;
        this.previewCanvas.height = 1050;

        // Event listeners
        const toleranceSlider = document.getElementById('lasso-tolerance');
        toleranceSlider.addEventListener('input', (e) => {
            this.tolerance = parseInt(e.target.value);
            document.getElementById('lasso-tolerance-val').textContent = `${this.tolerance}%`;
            this.updatePreview();
        });
    ...
    updatePreview() {
        ...
        document.getElementById('lasso-size').textContent = `${areaWidth}x${areaHeight}`;
        document.getElementById('lasso-coverage').textContent = `${coverage}%`;
    ...
    getAverageColor(data, width, height, centerX, centerY, size) {
